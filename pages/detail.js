                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>{symbol}</td>
                                    <td>
                                        <input step="0.0001" type="number" placeholder="输入最低价格" value={bLowPrice} onChange={(e) => setBLowPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="输入最高价格" value={bHighPrice} onChange={(e) => setBHighPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="输入每个格子数量(价格不能低于10U)" value={bAsset} onChange={(e) => setBAsset(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="输入挂单个数" value={bAmount} onChange={(e) => setBAmount(e.target.value)} />
                                    </td>
                                    <td>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>{symbol}</td>
                                    <td>
                                        <input step="0.0001" type="number" placeholder="输入最低价格" value={sLowPrice} onChange={(e) => setSLowPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="输入最高价格" value={sHighPrice} onChange={(e) => setSHighPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="输入每个格子出售数量(价格不能低于10U)" value={sAsset} onChange={(e) => setSAsset(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="输入挂单个数" value={sAmount} onChange={(e) => setSAmount(e.target.value)} />
                                    </td>
                                    <td>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>{symbol}</td>
                                    <td>
                                        <input type="number" placeholder="触发价格" value={aLowPrice} onChange={(e) => setALowPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="结束价格" value={aHighPrice} onChange={(e) => setAHighPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="吃单频率(秒)" value={aTimes} onChange={(e) => setATimes(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="购买数量" value={aAmount} onChange={(e) => setAAmount(e.target.value)} />
                                    </td>
                                    <td>
                                        <button
                                            onClick={() => {
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>{symbol}</td>
                                    <td>
                                        <input type="number" placeholder="触发价格" value={asLowPrice} onChange={(e) => setAsLowPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="结束价格" value={asHighPrice} onChange={(e) => setAsHighPrice(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="吃单频率(秒)" value={asTimes} onChange={(e) => setAsTimes(e.target.value)} />
                                    </td>
                                    <td>
                                        <input type="number" placeholder="购买数量" value={asAmount} onChange={(e) => setAsAmount(e.target.value)} />
                                    </td>
                                    <td>
                                        <button
                                            onClick={() => {
