...
const Home = ({ t }) => {
  ...
  useEffect(async () => {
    const timer = setInterval(async () => {}, 3000);
    return () => {
      clearInterval(timer);
    };
  }, []);
    ...
    <HeaderFooter activeIndex={1}>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.advantage}>
          ...
          <ul>
            <li className={styles.community}>
              <h1>
                <img src="/img/advantage1hover.gif" />
              </h1>
              <h2>Community </h2>
              <h2>Owned</h2>
              <h3></h3>
              <p>
                Mojito is owned by the community，Community Autonomous Exchange
              </p>
            </li>
            <li className={styles.swap}>
              <h1>
                <img src="/img/advantage2hover.gif" />
              </h1>
              <h2>Swap anytime and Anywhere</h2>
              <h3></h3>
              <p>
                Swap tokens and add liquidity,Not subject to centralizedservices
              </p>
            </li>
            <li className={styles.defi}>
              <h1>
                <img src="/img/advantage3hover.gif" />
              </h1>
              <h2>More interestings about Defi</h2>
              <h3></h3>
              <p>
                We will not stick to existing products, and will carry out more
        ...
        <div className={cx(styles.advantage, styles.bg_white)} id="faq">
          ...
          <div
            onClick={() => setFaq3State(!faq3State)}
            className={cx(styles.faq, {
              active: faq3State,
            })}
          >
